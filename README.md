...
- [Easy-MCP](https://github.com/Mark007-R/Easy-MCP) - Turns plain Python functions into secure MCP servers, with ready-made read-only GitHub and Postgres servers installable in one command.
